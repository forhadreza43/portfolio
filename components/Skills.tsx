...
const skillsData = {
   ...
   Backend: [
      ...
      {
         name: 'Prisma',
         icon: <SiPrisma className="text-[#25b096]" />,
         borderColor: 'border-cyan-300',
         shadowColor: 'hover:shadow-cyan-300/40',
      },
      {
      ...
      {
         name: 'Mongoose',
         icon: <SiMongoose className="text-[#d81919]" />,
         borderColor: 'border-cyan-300',
         shadowColor: 'hover:shadow-cyan-300/40',
      },
      {
   ...
   Tools: [
      ...
      // },
      {
         ...
         shadowColor: 'hover:shadow-purple-600/40',
      },
      {
         name: 'Bun',
         icon: <SiBun className="text-yellow-100" />,
         borderColor: 'border-yellow-100',
         shadowColor: 'hover:shadow-yellow-100/40',
      },
      {
         name: 'Pnpm',
         icon: <SiPnpm className="text-yellow-500" />,
         borderColor: 'border-yellow-500',
         shadowColor: 'hover:shadow-yellow-500/40',
      },
      {
